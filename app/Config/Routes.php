...
$routes->post('subject/save', 'Subject::save');
$routes->get('subject/edit/(:segment)', 'Subject::edit/$1');
$routes->post('subject/update', 'Subject::update');
$routes->delete('subject/delete/(:num)', 'Subject::delete/$1');
$routes->post('subject/fetchRecords', 'Subject::fetchRecords');

// Student routes
$routes->get('/students', 'Student::index');
$routes->post('students/save', 'Student::save');
$routes->get('students/edit/(:segment)', 'Student::edit/$1');
$routes->post('students/update', 'Student::update');
$routes->delete('students/delete/(:num)', 'Student::delete/$1');
$routes->post('students/fetchRecords', 'Student::fetchRecords');
